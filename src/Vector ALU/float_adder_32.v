...
module float_adder_32(
    ...
    //mantisa or fraction to be shifted
    reg[22:0] frac_shift;
    reg[23:0] significand_shift;
    //mantisa or fraction that remains same
    ...
    RightShifterv2 shift(.A(significand_shift), .amt(diff_amt), .out(significand_shifted));
